...
// Images
import irishTrails from '../assets/man+machine/irish-trails.png';
import researchBoard from '../assets/man+machine/research-board.jpg';
import experienceMapping from '../assets/man+machine/experience-mapping.jpg';
import pondering from '../assets/man+machine/thinking.jpg';
import cardSorting from '../assets/man+machine/card-sorting.jpg';
import cardSortingDone from '../assets/man+machine/card-sorting-done.jpg';
import sketching from '../assets/man+machine/sketching.jpg';
import paperPrototypeDone from '../assets/man+machine/paper-prototype-done.jpg';
import paperPrototypeScreen from '../assets/man+machine/paper-prototype-screen.jpg';
import paperPrototypeComponent from '../assets/man+machine/paper-prototype-component.jpg';
        ...
        <Cell desktopColumns={6} phoneColumns={4} tabletColumns={6} className="project">
          ...
          <main>
            ...
            <article className="content">
              ...
              <p>Oh dear.</p>
              <img src={irishTrails} alt="Irish Trails"/>
              ...
              <img src={researchBoard} alt="Research Board"/>
              ...
              <img src={cardSorting} alt="Card Sorting"/>
              <img src={cardSortingDone} alt="Card Sorting Done"/>
              ...
              <img src={paperPrototypeDone} alt="Paper Prototype Done"/>
              <img src={paperPrototypeScreen} alt="Paper Prototype Screen"/>
              <img src={paperPrototypeComponent} alt="Paper Prototype Component"/>
              <h2>Learning</h2>
