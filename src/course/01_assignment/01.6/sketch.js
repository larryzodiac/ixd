...
const seed = (sketch) => {
  ...
  sketch.x1 = (t) => sketch.map(Math.sin(t/50), 0, 1, offset, sketch.width-offset)
  sketch.y1 = (t) => sketch.map(Math.cos(t/20), 0, 1, offset, sketch.height-offset)
